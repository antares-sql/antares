export const ruRU = {
   ...
   message: {
      ...
      newInserStmtEvery: 'Новый INSERT оператор для каждого',
      ...
      checkAllTables: 'Выбрать все таблицы',
      ...
      editShortcut: 'Изменить горичие клавиши',
      ...
      openAllConnections: 'Открыть все соедиенения',
      ...
      executeSelectedQuery: 'Выполнить выбранный запрос',
